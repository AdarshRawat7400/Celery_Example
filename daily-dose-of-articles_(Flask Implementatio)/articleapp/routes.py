...
from articleapp.tasks import make_celery
...
def send_reset_email(email,username,token):
    ...
    <p>Dear {username},</p>
    <p>You requested for password reset. Please click on the link below to reset your password.</p>
    <h4><a href={url}>click here to reset</a></h4>
...
def request_password_reset():
    ...
    if form.validate_on_submit():
       ...
       send_reset_email.delay(user.email,user.username,token) 
